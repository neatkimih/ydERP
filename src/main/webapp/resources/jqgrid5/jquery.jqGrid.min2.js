...
!function(a) {
	...
	"use strict";$.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
		...
		parseDate : function(a, b, c, d) {
			...
			if (d.userLocalTime && 0 === q && 0 !== (q -= (new Date).getTimezoneOffset()) && o.setTime(Number(Number(o) + 60 * q * 1e3)), void
				0 === c) return o;
		...
		clearBeforeUnload : function(a) {
			...
			if (c.grid) {
				...
				for (e = f.length, d = 0; d < e; d++) c.hasOwnProperty(f[d]) && (c[f[d]] = null,
					delete
					c[f[d]]
				)
			}
		...
		return this.each(function() {
			...
			b(a, b, c, d) {
				if (e.p.multiselect && e.p.multiboxonly || e.p.multimail)
					...
					else if (e.p.multiboxonly && e.p.multimail) $(e).triggerHandler("jqGridSelectRow", [ a, !1, c ]), e.p.onSelectRow && e.p.onSelectRow.call(e, a, !1, c);else {
			...
			if (!this.grid) {
				...
				var y,
						...
						if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
							...
							if (e.p.grouping && (U = !0 === e.p.groupingView.groupCollapse, N = $.jgrid.getMethod("groupingPrepare")), O > 0 && e.p.page <= 0 && (e.p.page = 1), L && O) {
								...
								for (var V = $.isFunction(e.p.afterInsertRow), W = z ? l(m, "rownumBox", !1, "jqgrid-rownum") : "", X = x ? l(m, "multiBox", !1, "cbox") : ""; P < O;) {
									t = L[P], u = r(t, S + P), u = e.p.idPrefix + u;var Y = D.length;
						...
						if (a) {
							...
							for (z && (e.p.data = [], e.p._index = {}, e.p.localReader.id = y), e.p.reccount = 0, "local" === e.p.datatype ? (g = e.p.localReader, h = "local") : (g = e.p.jsonReader, h = "json"), e.p.page = A($.jgrid.getAccessor(a, g.page), e.p.page), e.p.lastpage = A($.jgrid.getAccessor(a, g.total), 1), e.p.records = A($.jgrid.getAccessor(a, g.records)), e.p.userData = $.jgrid.getAccessor(a, g.userdata) || {}, L && (p = $.jgrid.getMethod("addSubGridCell")), u = !1 === e.p.keyName ? $.isFunction(g.id) ? g.id.call(e, a) : g.id : e.p.keyName, g.repeatitems && e.p.keyName && isNaN(u) && (u = e.p.keyIndex), t = $.jgrid.getAccessor(a, g.root), null == t && $.isArray(a) && (t = a), t || (t = []), s = t.length, j = 0, s > 0 && e.p.page <= 0 && (e.p.page = 1), d && (P *= d + 1), "local" !== e.p.datatype || e.p.deselectAfterSort || (Q = !0), e.p.grouping && (Y = !0 === e.p.groupingView.groupCollapse, x = $.jgrid.getMethod("groupingPrepare")); j < s;) {
								if (n = t[j], void
									...
									0 === w && (w = O + j, 0 === D.length && g.cell))) {
									var ba = $.jgrid.getAccessor(n, g.cell) || n;
									w = null != ba && void
									0 !== ba[u] ? ba[u] : w, ba = null
								}
								w = e.p.idPrefix + w, Q && (q = e.p.multiselect ? -1 !== $.inArray(w, e.p.selarrrow) : w === e.p.selrow);var ca = U.length;
					...
					R = function(a) {
						...
						b(a) {
							...
							if (null != a.rules) try {
									f = a.rules.length && "OR" === a.groupOp.toString().toUpperCase(), f && s.orBegin();var l;
						...
						if ($.isArray(e.p.data)) {
							...
							if ((e.p.search || e.p.resetsearch) && e.p.grouping && e.p.groupingView._locgr) {
								...
								if (e.p.footerrow && e.p.userDataOnFooter) {
									for (D
										in
										e.p.userData) e.p.userData.hasOwnProperty(D) && (e.p.userData[D] = 0);
									E = !0
								}
								for (C = 0; C < y; C++) {
									if (E)
										for (D
											in
											e.p.userData) e.p.userData.hasOwnProperty(D) && (e.p.userData[D] += parseFloat(w[C][D] || 0));
									F.call($(e), w[C], C, x)
								}
							}
					...
					S = function(a, b) {
						...
						if (o = e.p.pager || "", o += e.p.toppager ? o ? "," + e.p.toppager : e.p.toppager : "") {
							if (j = $.jgrid.getRegional(e, "formatter.integer"), c = A(e.p.page), d = A(e.p.lastpage), $(".selbox", o)[this.p.useProp ? "prop" : "attr"]("disabled", !1), !0 === e.p.pginput && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + l(m, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "'></span>")), e.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + l(m, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "_toppager'></span>")), $(".ui-pg-input", o).val(e.p.page), k = e.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r, $(k).html($.fmatter ? $.fmatter.util.NumberFormat(e.p.lastpage, j) : e.p.lastpage)), e.p.viewrecords)
								if (0 === e.p.reccount) $(".ui-paging-info", o).html($.jgrid.getRegional(e, "defaults.emptyrecords", e.p.emptyrecords));else {
					...
					X = function(a) {
						if (!e.grid.hDiv.loading) {
							...
							case "script":
								...
								break;case "local":
							case "clientside":
								T(), e.p.datatype = "local", e.p._ald = !0;var q = R(!1);
					...
					Z = function(a, b) {
						var c,
							...
							j,
							k,
							o = "<td class='ui-pg-button " + n + "'><span class='ui-separator'></span></td>",
							q = "",
						...
						if (a = a.substr(1), b += "_" + a, c = "pg_" + a, d = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table " + l(m, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + d + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), e.p.rowList.length > 0) {
							t = '<td dir="' + i + '">', t += "<select " + l(m, "pgSelectBox", !1, "ui-pg-selbox") + ' size="1" role="listbox" title="' + ($.jgrid.getRegional(e, "defaults.pgrecs", e.p.pgrecs) || "") + '">';
							var v;
					...
					_ = function(a, b, c) {
						...
						var i = u.indexOf(d);
						-1 === i ? (u.push(d), v.push(h)) : h ? v[i] = h : (v.splice(i, 1), u.splice(i, 1)), e.p.sortorder = "", e.p.sortname = "";
					...
					aa = function(a, b, c, d, f) {
						if (e.p.colModel[b].sortable && !(e.p.savedRow.length > 0)) {
							if (c || (e.p.lastsort === b && "" !== e.p.sortname ? "asc" === e.p.sortorder ? e.p.sortorder = "desc" : "desc" === e.p.sortorder && (e.p.sortorder = "asc") : e.p.sortorder = e.p.colModel[b].firstsortorder || "asc", e.p.page = 1), e.p.multiSort) _(b, f, d);else {
								if (d) {
									if (e.p.lastsort === b && e.p.sortorder === d && !c) return;
									e.p.sortorder = d
								}
								var g,
									h = e.grid.headers[e.p.lastsort] ? e.grid.headers[e.p.lastsort].el : null,
					...
					ga = function(a, b, c, d) {
						...
						if (k) {
							...
							x += '<div><select size="1" id="oper1" class="' + s.filter_select + '">', $.each(v.odata, function(a, b) {
							...
							$(A).addClass(s.filter_input), x = $("<div></div>").append(A), j.append(x), x = '<div><select size="1" id="operand" class="' + s.filter_select + '">', $.each(h, function(a, b) {
							...
							}), x = '<div><select size="1" id="oper2" class="' + s.filter_select + '">' + r + "</select></div>", j.append(x), y = q || "", z = $.extend(k.searchoptions, {
								name : k.index || k.name,
					...
					ka = function(a, b, c) {
						...
						for (var t
							...
							if (e.p.colMenuCustom.hasOwnProperty(t)) {
								...
								v = $.map(v, function(a) {
									return $.trim(a)
								}), (u.colname === q || "_all_" === u.colname && -1 === $.inArray(q, v)) && (j = '<li class="ui-menu-item divider" role="separator"></li>', h = '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="' + u.id + '"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + u.icon + '"></span></td><td class="menu_text">' + u.title + "</td></tr></table></a></li>", "last" === u.position ? (o.push(j), o.push(h)) : "first" === u.position && (o.unshift(j), o.unshift(h)))
						}
						if (o.unshift(g), o.push(i), $("#gbox_" + e.p.id).append(o.join("")), $("#column_menu").addClass("ui-search-menu modal-content column-menu jqgrid-column-menu ui-menu " + s.menu_widget).css({
								left : b,
								top : c
							}), "ltr" === e.p.direction) {
						...
						$("#column_menu > li > a").hover(function() {
							...
							var b,
								c;
							"columns" === $(this).attr("data-value") && (b = $(this).parent().width() + 8, c = $(this).parent().position().top - 5, fa(c, b, $(this).parent())), "filtering" === $(this).attr("data-value") && (b = $(this).parent().width() + 8, c = $(this).parent().position().top - 5, ga(a, c, b, $(this).parent())), $(this).addClass(p)
						}, function() {
							$(this).removeClass(p)
						}).click(function() {
							var b = $(this).attr("data-value"),
								c = e.grid.headers[a].el;
							if ("sortasc" === b ? aa("jqgh_" + e.p.id + "_" + k.name, a, !0, "asc", c) : "sortdesc" === b ? aa("jqgh_" + e.p.id + "_" + k.name, a, !0, "desc", c) : "grouping" === b ? ia(a, d) : "freeze" === b && ja(a, f), -1 === b.indexOf("sort") && "grouping" !== b && "freeze" !== b || $(this).remove(), e.p.colMenuCustom.hasOwnProperty(b)) {
								var g = e.p.colMenuCustom[b];
								$.isFunction(g.funcname) && (g.funcname.call(e, q), g.closeOnRun && $(this).remove())
							}
				...
				if (e.p.sortorder = e.p.sortorder.toLowerCase(), $.jgrid.cell_width = $.jgrid.cellWidth(), !0 === e.p.grouping && (e.p.scroll = !1, e.p.rownumbers = !1, e.p.treeGrid = !1, e.p.gridview = !0), !0 === this.p.treeGrid) {
					...
					} catch (a) {} "local" !== e.p.datatype && (e.p.localReader = {
						id : "_id_"
					})
				}
				if (this.p.subGrid) try {
						$(e).jqGrid("setSubGrid")
					} catch (a) {} this.p.multiselect && (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/>"), this.p.colModel.unshift({
					name : "cb",
				...
				if (!0 === e.p.shrinkToFit && !0 === e.p.forceFit)
					for (j = e.p.colModel.length - 1; j >= 0; j--)
						if (!e.p.colModel[j].hidden) {
							e.p.colModel[j].resizable = !1;break
				}
				...
				for (j = 0; j < this.p.colNames.length; j++) {
					var ya = e.p.headertitles ? ' title="' + $.jgrid.stripHtml(e.p.colNames[j]) + '"' : "";
					...
					ta.title && (ta.title = !0), ta.lso = "", ma === e.p.sortname && (e.p.lastsort = j), e.p.multiSort && -1 !== (w = $.inArray(ma, u)) && (ta.lso = v[w]), ua += sa, e.p.colMenu && ta.colmenu && (ua += "<a class='" + ("ltr" === e.p.direction ? "colmenu" : "colmenu-rtl") + "'><span class='colmenuspan " + r + " " + s.icon_menu + "'></span></a>"), ua += "</div></th>"
				}
				...
				if (e.p.disableClick = !1, $("th", Ea).each(function(a) {
					...
					} catch (a) {} e.p.footerrow && (Ca += "</tr></tbody></table>"), Fa += "</tr>", ra = document.createElement("tbody"), this.appendChild(ra), $(this).addClass(l(m, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Fa), e.p.altRows && $(this).addClass(l(m, "stripedTable", !0, "")), Fa = null;
				var Ga = $("<table " + l(m, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + e.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(ua),
					Ha = !(!e.p.caption || !0 !== e.p.hiddengrid),
					Ia = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>");
				ua = null, f.hDiv = document.createElement("div"), f.hDiv.style.width = f.width - Da + "px", f.hDiv.className = l(m, "headerDiv", !0, "ui-jqgrid-hdiv"), $(f.hDiv).append(Ia), $(Ia).append(Ga), Ga = null, Ha && $(f.hDiv).hide(), e.p.pager && ("string" == typeof
				...
				$(e).before(f.hDiv).on({
					click : function(a) {
						...
						if ("A" !== pa.tagName && ("INPUT" !== pa.tagName && "TEXTAREA" !== pa.tagName && "OPTION" !== pa.tagName && "SELECT" !== pa.tagName || c))
							...
							} else if (e.p.multiselect && c && d) $(e).jqGrid("setSelection", Ja, !0, a);
							else if (pa.length > 0) try {
					...
					reloadGrid : function(a, b) {
						...
						return e.grid.prevRowHeight && e.p.scroll && void
							0 === b.page ? (
								delete
								e.p.lastpage
								, e.grid.populateVisible()) : e.grid.populate(), !0 === e.p.inlineNav && $(e).jqGrid("showAddEditButtons"), !1
					},
					dblclick : function(a) {
						if (pa = a.target, qa = $(pa, e.rows).closest("tr.jqgrow"), 0 !== $(qa).length) {
							Ja = qa[0].rowIndex, Ka = $.jgrid.getCellIndex(pa);
							var b = $(e).triggerHandler("jqGridDblClickRow", [ $(qa).attr("id"), Ja, Ka, a ]);
					...
					contextmenu : function(a) {
						if (pa = a.target, qa = $(pa, e.rows).closest("tr.jqgrow"), 0 !== $(qa).length) {
							...
							var b = $(e).triggerHandler("jqGridRightClickRow", [ $(qa).attr("id"), Ja, Ka, a ]);
				...
				var Oa = !0 === e.p.hidegrid ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + q + "' title='" + ($.jgrid.getRegional(e, "defaults.showhide", e.p.showhide) || "") + "' />").hover(function() {
					Oa.addClass(p)
				}, function() {
					Oa.removeClass(p)
				...
				if ($(f.cDiv).append(Oa).append("<span class='ui-jqgrid-title'>" + e.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === i ? "-rtl" : "") + " " + l(m, "gridtitleBox", !0)), !0 === e.p.menubar) {
					var Pa = '<ul id="' + e.p.id + '_menubar" class="ui-search-menu modal-content column-menu ui-menu jqgrid-caption-menu ' + s.menu_widget + '" role="menubar" tabindex="0"></ul>';
					$("#gbox_" + e.p.id).append(Pa), $(f.cDiv).append("<a role='link' class='ui-jqgrid-menubar menubar-" + ("rtl" === i ? "rtl" : "ltr") + "' style=''><span class='colmenuspan " + r + " " + s.icon_toolbar_menu + "'></span></a>"), $(".ui-jqgrid-menubar", f.cDiv).hover(function() {
						$(this).addClass(p)
					}, function() {
						$(this).removeClass(p)
					}).on("click", function(a) {
						var b = $(a.target).offset();
						$("#" + e.p.id + "_menubar").show(), "rtl" === e.p.direction && $("#" + e.p.id + "_menubar").css({
				...
				if (e.p.toppager && (e.p.toppager = $.jgrid.jqID(e.p.id) + "_toppager", f.topDiv = $("<div id='" + e.p.toppager + "'></div>")[0], e.p.toppager = "#" + e.p.toppager, $(f.topDiv).addClass(l(m, "toppagerBox", !0, "ui-jqgrid-toppager")).width(f.width - Da).insertBefore(f.hDiv), Z(e.p.toppager, "_t")), e.p.footerrow && (f.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Ia = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>"), $(f.sDiv).append(Ia).width(f.width - Da).insertAfter(f.hDiv), $(Ia).append(Ca), f.footers = $(".ui-jqgrid-ftable", f.sDiv)[0].rows[0].cells, e.p.rownumbers && (f.footers[0].className = l(m, "rownumBox", !0, "jqgrid-rownum")), Ha && $(f.sDiv).hide()), Ia = null, e.p.caption) {
					...
					!0 === e.p.hidegrid && ($(".ui-jqgrid-titlebar-close", f.cDiv).click(function(a) {
						...
						return !0 === e.p.toolbar[0] && ("both" === e.p.toolbar[1] && (d += ", #" + $(f.ubDiv).attr("id")), d += ", #" + $(f.uDiv).attr("id")), b = $(d, "#gview_" + $.jgrid.jqID(e.p.id)).length, "visible" === e.p.gridstate ? $(d, "#gbox_" + $.jgrid.jqID(e.p.id)).slideUp("fast", function() {
								...
								0 === --b && ($("span", g).removeClass(Na).addClass(Ma), Ha && (e.p.datatype = Ra, X(), Ha = !1), e.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(e.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(e.p.id)).show(), $(e).triggerHandler("jqGridHeaderClick", [ e.p.gridstate, a ]), c && (Ha || e.p.onHeaderClick.call(e, e.p.gridstate, a)))
							}), !1
					}), Ha && (e.p.datatype = "local", $(".ui-jqgrid-titlebar-close", f.cDiv).trigger("click")))
				} else
					$(f.cDiv).hide(), e.p.toppager || $(f.hDiv).addClass(l(e.p.styleUI + ".common", "cornertop", !0));
					...
					for (b && !0 === b && j.p.data.length > 0 || (b = !1); g < d;) f && (i = j.rows[g + 1]), $(i).hasClass("jqgrow") && (b ? e = j.p.data[j.p._index[i.id]] : $('td[role="gridcell"]', i).each(function(a) {
							if ("cb" !== (h = j.p.colModel[a].name) && "subgrid" !== h && "rn" !== h)
								if (!0 === j.p.treeGrid && h === j.p.ExpandColumn)
									e[h] = $.jgrid.htmlDecode($("span:first", this).html());else
									try {
					...
					if (b) try {
							if ($(this.p.colModel).each(function(c) {
								...
								if (i.p.treeGrid)
									for (l
										in
										i.p.treeReader) i.p.treeReader.hasOwnProperty(l) &&
										delete
										k[i.p.treeReader[l]];
								void
		...
		addRowData : function(a, b, c, d) {
			...
			return b && ($.isArray(b) ? (m = !0, n = a) : (b = [ b ], m = !1), this.each(function() {
					...
					for (i && (s = $(v).jqGrid("getStyleUI", v.p.styleUI + ".base", "rownumBox", !1, "jqgrid-rownum")), g && (t = $(v).jqGrid("getStyleUI", v.p.styleUI + ".base", "multiBox", !1, "cbox")); x < w;) {
						...
						if (f.unshift(v.constructTr(a, !1, y, z, o)), f[f.length] = "</tr>", 0 === v.rows.length) $("table:first", v.grid.bDiv).append(f.join(""));else
							switch (c) {
							case "last":
				...
				if (e.grid) {
					for (a || (a = e.p.sortname), d = 0; d < e.p.colModel.length; d++)
						if (e.p.colModel[d].index === a || e.p.colModel[d].name === a) {
							f = d, !0 === e.p.frozenColumns && !0 === e.p.colModel[d].frozen && (g = e.grid.fhDiv.find("#" + e.p.id + "_" + a));break
					}
					if (-1 !== f) {
			...
			return this.each(function() {
				...
				if ($.isArray(a))
					for (var f = 0; f < a.length; f++) {
						b = a[f], b.id || (b.id = $.jgrid.randId());var g = "";
	...
	"use strict";a.fmatter = {}, a.extend(a.fmatter, {
		...
		var g = c;
		d = a.extend({}, a.jgrid.getRegional(this, "formatter"), d);try {
		...
		if (void
			...
			var h,
				i = !0 == (null != c.colModel.editoptions && !0 === c.colModel.editoptions.multiple),
				j = [];
	...
	"use strict";a.extend(a.jgrid, {
		...
		hideModal : function(b, c) {
			...
			if (a.fn.jqm && !0 === c.jqm) a(b).attr("aria-hidden", "true").jqmHide();else {
				...
				} catch (a) {} a(b).hide().attr("aria-hidden", "true")
			}
		...
		createModal : function(b, c, d, e, f, g, h) {
			...
			if (d.resize)
				if (a.fn.jqResize) a(m).append("<div class='jqResize " + k.resizable + " " + l.icon_base + " " + k.icon_resizable + "'></div>"), a("#" + a.jgrid.jqID(b.themodal)).jqResize(".jqResize", !!b.scrollelm && "#" + a.jgrid.jqID(b.scrollelm));else
					try {
						a(m).resizable({
							handles : "se, sw",
		...
		viewModal : function(b, c) {
			...
			if (void
				...
				c.focusField || c.focusField ? c.focusField = 0 : c.focusField = !1, a.fn.jqm && !0 === c.jqm)
				c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow();else {
				if ("" !== c.gbox) {
		...
		info_dialog : function(b, c, d, e) {
			...
			a.jgrid.createModal({
				...
				modal : f.modal,
				jqm : g
			}), a.isFunction(f.afterOpen) && f.afterOpen();try {
				a("#info_dialog").focus()
			} catch (a) {}
		},
		bindEv : function(b, c) {
		...
		createEl : function(b, c, d, e, f) {
			...
			case "textarea":
				h = document.createElement("textarea"), e ? c.cols || a(h).css({
					width : "98%"
				}) : c.cols || (c.cols = 20), c.rows || (c.rows = 2), ("&nbsp;" === d || "&#160;" === d || 1 === d.length && 160 === d.charCodeAt(0)) && (d = ""), h.value = d, a(h).attr({
					role : "textbox",
					multiline : "true"
				}), g(h, c);
				break;case "checkbox":
				...
				break;case "select":
				h = document.createElement("select"), h.setAttribute("role", "select");var l,
					m = [];
				if (!0 === c.multiple ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
					...
					try {
						n = c.rowId
					} catch (a) {} i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
			...
			case "file":
				...
				break;case "custom":
				h = document.createElement("span");try {
				...
				break;default:
				var B;
				B = "button" === b ? "button" : "textbox", h = document.createElement("input"), h.type = b, h.value = d, "button" !== b && (e ? c.size || a(h).css({
					width : "96%"
				}) : c.size || (c.size = 20)), a(h).attr("role", B), g(h, c)
			}
			return h
		},
			...
			if (void
				...
				if ("string" == typeof
					...
					for (g = 0, j = m.length; g < j; g++)
						if (m[g].name === c) {
							f = m[g].editrules, c = g, null != m[g].formoptions && (h = m[g].formoptions.label);break
					}
				} else
					c >= 0 && (f = m[c].editrules);
			else
		...
		validateForm : function(b) {
			...
			for (c = 0; c < b.elements.length; c++)
				if (d = b.elements[c], ("INPUT" === d.nodeName || "TEXTAREA" === d.nodeName || "SELECT" === d.nodeName) && (void
					0 !== d.willValidate ? ("INPUT" === d.nodeName && d.type !== d.getAttribute("type") && d.setCustomValidity(a.jgrid.LegacyValidation(d) ? "" : "error"), d.reportValidity()) : (d.validity = d.validity || {}, d.validity.valid = a.jgrid.LegacyValidation(d)), !d.validity.valid)) {
					e = !1;break
			}
			return e
		},
			...
			return d = a.extend(!0, {
						...
						if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
								if (h = this.name, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
									if (!1 === r)
										...
										k = a("td[role='gridcell']:eq(" + n + ")", d.rows[r]).text();else {
										try {
									...
									if ("_empty" === c && t.defaultValue && (k = a.isFunction(t.defaultValue) ? t.defaultValue.call(s) : t.defaultValue), this.edittype || (this.edittype = "text"), s.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(s, this.edittype, t, k, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), a(m).addClass("FormElement"), a.inArray(this.edittype, [ "text", "textarea", "password", "select", "color", "date", "datetime", "datetime-local", "email", "month", "number", "range", "search", "tel", "time", "url", "week" ]) > -1 && a(m).addClass(g.inputClass), o = !0, F) {
										...
										if (j = a(e).find("tr[rowpos=" + w + "]"), v.rowabove) {
											var A = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + v.rowcontent + "</td></tr>");
					...
					i(c, d, e) {
						var f,
							...
							k,
							l = 0;
						(b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (s.p.savedData = {}, s.p.savedData[d.p.id + "_id"] = c);var m = d.p.colModel;
					...
					k() {
						...
						if (q && "object" == typeof
							...
							q && (u = q), b[s.p.id].html5Check && !a.jgrid.validateForm(L[0])) return !1;
						for (g
							in
							u)
						...
						if (j(), n[0] && (o = a(s).triggerHandler("jqGridAddEditClickSubmit", [ b[s.p.id], u, w ]), void
							...
							if (b[s.p.id].processing = !0, a("#sData", A + "_2").addClass(h.active), m = b[s.p.id].url || a(s).jqGrid("getGridParam", "editurl"), f = p.oper, e = "clientArray" === m ? s.p.keyName : p.id, u[f] = "_empty" === a.trim(u[s.p.id + "_id"]) ? p.addoper : p.editoper, u[f] !== p.addoper ? u[e] = u[s.p.id + "_id"] : void
								0 === u[e] && (u[e] = u[s.p.id + "_id"]),
								delete
								u[s.p.id + "_id"]
								, u = a.extend(u, b[s.p.id].editData, o), !0 === s.p.treeGrid) {
								if (u[f] === p.addoper) {
									k = a(s).jqGrid("getGridParam", "selrow");
									var r = "adjacency" === s.p.treeGridModel ? s.p.treeReader.parent_id_field : "parent_id";
									u[r] = k
								}
								for (l
									in
								...
								complete : function(g, j) {
									...
									if (a("#sData", A + "_2").removeClass(h.active), u[e] = s.p.idPrefix + u[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(s).triggerHandler("jqGridAddEditErrorTextFormat", [ g, w ]), a.isFunction(b[s.p.id].errorTextFormat) ? n[1] = b[s.p.id].errorTextFormat.call(s, g, w) : n[1] = j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(s).triggerHandler("jqGridAddEditAfterSubmit", [ g, u, w ]), void
										0 === n && (n = [ !0, "", "" ]), n[0] && a.isFunction(b[s.p.id].afterSubmit) && (n = b[s.p.id].afterSubmit.call(s, g, u, w))), !1 === n[0]) a(".FormError", y).html(n[1]), a(".FormError", y).show();
											...
											a(s).triggerHandler("jqGridAddEditAfterComplete", [ c, u, a(y), w ]);try {
							...
							if (v.url || b[s.p.id].useDataProxy || (a.isFunction(s.p.dataProxy) ? b[s.p.id].useDataProxy = !0 : (n[0] = !1, n[1] += " " + G.nourl)), n[0])
								if (b[s.p.id].useDataProxy) {
									...
									"clientArray" === v.url ? (b[s.p.id].reloadAfterSubmit = !1, u = v.data, v.complete({
										status : 200,
										statusText : ""
									}, "")) : a.ajax(v)
						}
					...
					p() {
						...
						if (s.p.multiselect && b[s.p.id].editselected) {
							for (var f = [], g = 0, h = d.length; g < h; g++) -1 !== a.inArray(d[g], s.p.selarrrow) && f.push(d[g]);
					...
					if (s.grid && c) {
						...
						if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function() {
							...
							var X;
							F ? (a(L).find("#pData").replaceWith(P), a(L).find("#nData").replaceWith(Q), a(L).find("#sData").replaceWith(R), a(L).find("#cData").replaceWith(S), X = a("<div id=" + z + "></div>").append(L)) : X = a("<div></div>").append(L).append(U), a(L).append("<div class='binfo topinfo bottominfo'>" + b[s.p.id].bottominfo + "</div>");
							var Y = a(".ui-jqgrid").css("font-size") || "11px";
							if (a.jgrid.createModal(B, X, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(s.p.id), a("#gbox_" + a.jgrid.jqID(s.p.id))[0], null, {
									"font-size" : Y
								}), M && (a("#pData, #nData", A + "_2").css("float", "right"), a(".EditButton", A + "_2").css("text-align", "left")), b[s.p.id].topinfo && a(".tinfo", y).show(), b[s.p.id].bottominfo && a(".binfo", y).show(), X = null, U = null, a("#" + a.jgrid.jqID(B.themodal)).keydown(function(c) {
									var e = c.target;
								...
								var Z = d.zIndex || 999;
								Z++, a("#" + B.themodal).append("<div class='" + d.overlayClass + " jqgrid-overlay confirm' style='z-index:" + Z + ";display:none;position:absolute;'>&#160;</div><div class='confirm ui-jqconfirm " + h.content + "' style='z-index:" + (Z + 1) + "'>" + d.saveData + "<br/><br/>" + R + Q + S + "</div>"), a("#sNew", "#" + a.jgrid.jqID(B.themodal)).click(function() {
		...
		viewGridRow : function(c, d) {
			...
			return d = a.extend(!0, {
					...
					if (l.grid && c) {
						...
						var v = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px",
						...
						if (a(l.p.colModel).each(function() {
							...
							var H = a("<div></div>").append(x).append("<table border='0' class='EditTable' id='" + o + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + d.labelswidth + "'>" + (z ? D + C : C + D) + "</td><td class='EditButton'>" + F + "</td></tr></tbody></table>"),
								I = a(".ui-jqgrid").css("font-size") || "11px";
							a.jgrid.createModal(r, H, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(l.p.id), a("#gview_" + a.jgrid.jqID(l.p.id))[0], null, {
								"font-size" : I
							}), z && (a("#pData, #nData", "#" + o + "_2").css("float", "right"), a(".EditButton", "#" + o + "_2").css("text-align", "left")), d.viewPagerButtons || a("#pData, #nData", "#" + o + "_2").hide(), H = null, a("#" + r.themodal).keydown(function(c) {
			...
			return d = a.extend(!0, {
					...
					if (e.grid && c) {
						...
						if (b[e.p.id].styleUI = e.p.styleUI || "jQueryUI", a.isArray(c) && (c = c.join()), void
							...
							var r = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px",
							...
							var u = "<a id='dData' class='fm-button " + h.button + "'>" + d.bSubmit + "</a>",
							...
							if (t += "<table class='EditTable ui-common-table' id='" + o + "_2'><tbody><tr><td><hr class='" + h.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + w + "</td></tr></tbody></table>", d.gbox = "#gbox_" + a.jgrid.jqID(l), a.jgrid.createModal(q, t, b[e.p.id], "#gview_" + a.jgrid.jqID(e.p.id), a("#gview_" + a.jgrid.jqID(e.p.id))[0], null, {
									"font-size" : x
								}), a(".fm-button", "#" + o + "_2").hover(function() {
									a(this).addClass(h.hover)
								}, function() {
									a(this).removeClass(h.hover)
									...
									if (m = {}, m = a(e).triggerHandler("jqGridDelRowClickSubmit", [ b[e.p.id], n ]), void
											...
											complete : function(c, i) {
												...
												if (a("#dData", "#" + o + "_2").removeClass(h.active), c.status >= 300 && 304 !== c.status ? (g[0] = !1, g[1] = a(e).triggerHandler("jqGridDelRowErrorTextFormat", [ c ]), a.isFunction(b[e.p.id].errorTextFormat) && (g[1] = b[e.p.id].errorTextFormat.call(e, c)), void
													...
													if (a.isFunction(b[e.p.id].afterComplete) || a._data(a(e)[0], "events").hasOwnProperty("jqGridDelRowAfterComplete")) {
														var k = c;
														setTimeout(function() {
															a(e).triggerHandler("jqGridDelRowAfterComplete", [ k, f ]);try {
										...
										if (p.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (g[0] = !1, g[1] += " " + a.jgrid.getRegional(e, "errors.nourl"))), g[0])
											if (b[e.p.id].useDataProxy) {
												...
												"clientArray" === p.url ? (f = p.data, p.complete({
													status : 200,
													statusText : ""
												}, "")) : a.ajax(p)
									}
					...
					if (!this.p.navGrid) {
						...
						if (p.grid && "string" == typeof
							...
							if (a(p).data("navGrid") || a(p).data("navGrid", c), n = a(p).data("navGrid"), p.p.force_regional && (n = a.extend(n, i)), void
								...
								0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (n.alertleft = document.documentElement.clientWidth, n.alerttop = document.documentElement.clientHeight) : (n.alertleft = 1024, n.alerttop = 768), n.alertleft = n.alertleft / 2 - parseInt(n.alertwidth, 10) / 2, n.alerttop = n.alerttop / 2 - 25);
								var q = a(".ui-jqgrid").css("font-size") || "11px";
								a.jgrid.createModal(o, "<div>" + n.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
							...
							for (n.cloneToTop && p.p.toppager && (s = 2), r = 0; r < s; r++) {
								var v,
									w,
									x,
									y = a("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"),
									z = "<td class='ui-pg-button " + l.disabled + "' style='width:4px;'><span class='ui-separator'></span></td>";
								0 === r ? (w = b, x = p.p.id, w === p.p.toppager && (x += "_top", s = 1)) : (w = p.p.toppager, x = p.p.id + "_top"), "rtl" === p.p.direction && a(y).attr("dir", "rtl").css("float", "right"), e = e || {}, n.add && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.addicon + "'></span>" + n.addtext + "</div>"), a("tr", y).append(v), a(v, y).attr({
									title : n.addtitle || "",
									id : e.id || "add_" + x
								}).click(function() {
									return a(this).hasClass(l.disabled) || (a.isFunction(n.addfunc) ? n.addfunc.call(p) : a(p).jqGrid("editGridRow", "new", e)), !1
								}).hover(t, u), v = null), d = d || {}, n.edit && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.editicon + "'></span>" + n.edittext + "</div>"), a("tr", y).append(v), a(v, y).attr({
									title : n.edittitle || "",
									id : d.id || "edit_" + x
								}).click(function() {
									...
									return !1
								}).hover(t, u), v = null), h = h || {}, n.view && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.viewicon + "'></span>" + n.viewtext + "</div>"), a("tr", y).append(v), a(v, y).attr({
									title : n.viewtitle || "",
									id : h.id || "view_" + x
								}).click(function() {
									if (!a(this).hasClass(l.disabled)) {
									...
									return !1
								}).hover(t, u), v = null), f = f || {}, n.del && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.delicon + "'></span>" + n.deltext + "</div>"), a("tr", y).append(v), a(v, y).attr({
									title : n.deltitle || "",
									id : f.id || "del_" + x
								}).click(function() {
									if (!a(this).hasClass(l.disabled)) {
									...
									return !1
								}).hover(t, u), v = null), (n.add || n.edit || n.del || n.view) && a("tr", y).append(z), g = g || {}, n.search && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.searchicon + "'></span>" + n.searchtext + "</div>"), a("tr", y).append(v), a(v, y).attr({
									title : n.searchtitle || "",
									id : g.id || "search_" + x
								}).click(function() {
									return a(this).hasClass(l.disabled) || (a.isFunction(n.searchfunc) ? n.searchfunc.call(p, g) : a(p).jqGrid("searchGrid", g)), !1
								}).hover(t, u), g.showOnLoad && !0 === g.showOnLoad && a(v, y).click(), v = null), n.refresh && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.refreshicon + "'></span>" + n.refreshtext + "</div>"), a("tr", y).append(v), a(v, y).attr({
									...
									if (!a(this).hasClass(l.disabled)) {
										a.isFunction(n.beforeRefresh) && n.beforeRefresh.call(p), p.p.search = !1, p.p.resetsearch = !0;try {
											if ("currentfilter" !== n.refreshstate) {
												var b = p.p.id;
												p.p.postData.filters = "";try {
													a("#fbox_" + a.jgrid.jqID(b)).jqFilter("resetFilter")
												} catch (a) {} a.isFunction(p.clearToolbar) && p.clearToolbar.call(p, !1)
											}
										} catch (a) {} switch (n.refreshstate) {
										case "firstpage":
						...
						if (!a(this).hasClass(n.disabled)) {
							a.isFunction(d.beforeRefresh) && d.beforeRefresh.call(j), j.p.search = !1, j.p.resetsearch = !0;try {
								if ("currentfilter" !== d.refreshstate) {
									var b = j.p.id;
									j.p.postData.filters = "";try {
										a("#fbox_" + a.jgrid.jqID(b)).jqFilter("resetFilter")
									} catch (a) {} a.isFunction(j.clearToolbar) && j.clearToolbar.call(j, !1)
								}
							} catch (a) {} switch (d.refreshstate) {
							case "firstpage":
	...
	"use strict";a.fn.jqFilter = function(b) {
				...
				if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
					...
					this.onchange = function() {
						...
						if (k.append(l), !0 === this.p.ruleButtons) {
							var m = a("<select size='1' class='opsel " + i.srSelect + "'></select>");
							l.append(m);
							var n,
								o = "";
						...
						if (this.p.groupButton && (p = a("<input type='button' value='+ {}' title='" + f.p.subgroup + "' class='add-group " + j.button + "'/>"), p.on("click", function() {
							...
							var q,
								r = a("<input type='button' value='+' title='" + f.p.addrule + "' class='add-rule ui-add " + j.button + "'/>");
							r.on("click", function() {
								for (void
						...
						if (null !== c) {
							var s = a("<input type='button' value='-' title='" + f.p.delgroup + "' class='delete-group " + j.button + "'/>");
							l.append(s), s.on("click", function() {
								for (d = 0; d < c.groups.length; d++)
									if (c.groups[d] === b) {
										c.groups.splice(d, 1);break
								}
						...
						if (void
							...
							for (d = 0; d < b.groups.length; d++) {
								var t = a("<tr></tr>");
								g.append(t);var u = a("<td class='first'></td>");
								t.append(u);var v = a("<td colspan='4'></td>");
						...
						r.append(t), t.on("change", function() {
							...
							if (l) {
								...
								var g = a.jgrid.createEl.call(o, l.inputtype, l.searchoptions, "", !0, n.p.ajaxSelectOptions || {}, !0);
								...
								if (a(".selectopts", k).empty().append(j), a(".selectopts", k)[0].selectedIndex = 0, a.jgrid.msie() && a.jgrid.msiever() < 9) {
									var p = parseInt(a("select.selectopts", k)[0].offsetWidth, 10) + 1;
						...
						var z = a.jgrid.createEl.call(o, l.inputtype, l.searchoptions, b.data, !0, n.p.ajaxSelectOptions || {}, !0);
						"nu" !== b.op && "nn" !== b.op || (a(z).attr("readonly", "true"), a(z).attr("disabled", "true"));
						var A = a("<select size='1' class='selectopts " + i.srSelect + "'></select>");
						...
						if (p.append(C), !0 === this.p.ruleButtons) {
							var D = a("<input type='button' value='-' title='" + n.p.delrule + "' class='delete-rule ui-del " + j.button + "'/>");
							C.append(D), D.on("click", function() {
								for (d = 0; d < c.rules.length; d++)
									if (c.rules[d] === b) {
										c.rules.splice(d, 1);break
								}
						...
						for (c = 0; c < this.p.ops.length; c++)
							if (this.p.ops[c].oper === b.op) {
								g = this.p.operands.hasOwnProperty(b.op) ? this.p.operands[b.op] : "", h = this.p.ops[c].oper;break
						}
						for (c = 0; c < this.p.columns.length; c++)
							if (this.p.columns[c].name === b.field) {
								d = this.p.columns[c];break
						}
						return void
		...
		filterRefactor : function(b) {
			...
			try {
				if (h = "string" == typeof
					b.ruleGroudp ? a.jgrid.parse(b.ruleGroup) : b.ruleGroup, h.rules && h.rules.length)
					for (c = h.rules, d = 0; d < c.length; d++) e = c[d], a.inArray(e.filed, b.ssfield) && (f = e.data.split(b.splitSelect), f.length > 1 && (void
						...
						var e,
							...
							k = function() {
								...
								if (a.each(d.p.colModel, function() {
										var p = a("#gs_" + d.p.idPrefix + a.jgrid.jqID(this.name), !0 === this.frozen && !0 === d.p.frozenColumns ? d.grid.fhDiv : d.grid.hDiv);
										...
										if ("bt" === f && (m = !0), c || "nu" === f || "nn" === f) h[e] = c, j[e] = f, i++;else
											try {
												delete
												d.p.postData[e]
											} catch (a) {}
									...
									if (!0 === b.stringResult || "local" === d.p.datatype || !0 === b.searchOperators) {
										...
										if (k && a.jgrid.filterRefactor({
											...
											for (t = s.rules, u = 0; u < t.length; u++) w = t[u], "bt" === w.op && (x = w.data.split("..."), x.length > 1 && (void
												0 === s.groups && (s.groups = []), y = {
													groupOp : "AND",
													groups : [],
													rules : []
									...
									var A = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch");
								...
								} else if (a.isFunction(o)) o.call(d, n[1]);else {
							...
							l = function(c) {
								...
								c = "boolean" != typeof
									...
									var b,
										c = a("#gs_" + d.p.idPrefix + a.jgrid.jqID(this.name), !0 === this.frozen && !0 === d.p.frozenColumns ? d.grid.fhDiv : d.grid.hDiv);
								...
								var l = "stop" === a(d).triggerHandler("jqGridToolbarBeforeClear");
							...
							n = function(c, e, f) {
								...
								for (var g, j, l = a(".ui-jqgrid").css("font-size") || "11px", m = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + l + ";left:" + e + "px;top:" + f + 'px;">', n = a(c).attr("soper"), o = [], p = 0, q = a(c).attr("colname"), r = d.p.colModel.length; p < r && d.p.colModel[p].name !== q;) p++;
			...
			return b = a.extend(!0, {
					...
					if (d.grid) {
						...
						if (b.styleUI = d.p.styleUI, "string" == typeof
							...
							w = !1, b.tmplNames && b.tmplNames.length && (w = !0, v = "<tr><td class='ui-search-label'>" + b.tmplLabel + "</td>", v += "<td><select size='1' class='ui-template " + k.srSelect + "'>", v += "<option value='default'>Default</option>", a.each(b.tmplNames, function(a, b) {
							...
							}), !0 === b.multipleGroup && (b.multipleSearch = !0), a(d).triggerHandler("jqGridFilterInitialize", [ a("#" + f) ]), a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + f)), b.gbox = "#gbox_" + f;
							var C = a(".ui-jqgrid").css("font-size") || "11px";
							b.layer ? a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "string" == typeof
							...
							b.layer ? {
								...
								"font-size" : C
							}) : a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], null, {
								"font-size" : C
			...
			return c = a.extend(!0, {
					...
					if (d.grid) {
						...
						if (b += "", "local" === d.p.datatype) {
							...
							var j = "stop" === a(d).triggerHandler("jqGridFilterInputBeforeSearch");
					...
					if (m.grid && !1 !== (f = a(m).jqGrid("getInd", b, !0))) {
						...
						e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = m.p.colModel, a('td[role="gridcell"]', f).each(function(e) {
							...
							if ("cb" !== c && "subgrid" !== c && "rn" !== c && (m.p.autoencode && (d = a.jgrid.htmlDecode(d)), l[c] = d, !0 === g[e].editable)) {
								...
								var k = a.jgrid.createEl.call(m, g[e].edittype, h, d, !0, a.extend({}, a.jgrid.ajaxOptions, m.p.ajaxSelectOptions || {}));
						...
						k.focusField && parseInt(k.focusField, 10) <= g.length && (j = k.focusField), setTimeout(function() {
							var b = a("td:eq(" + j + ") :input:visible", f).not(":disabled");
							b.length > 0 && b.focus()
				...
				if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
					...
					if (E = !1 === k.p.keyName ? F.id : k.p.keyName, r) {
						if (r[F.oper] = F.editoper, void
							...
							if (void
								0 !== k.p._index[H] && (k.p._index[r[E]] = k.p._index[H],
								delete
								k.p._index[H]
								), b = k.p.idPrefix + r[E], a(p).attr("id", b), k.p.selrow === G && (k.p.selrow = b), a.isArray(k.p.selarrrow)) {
		...
		restoreRow : function(b, c) {
			...
			return "object" === a.type(d[0]) ? e = d[0] : a.isFunction(c) && (e.afterrestorefunc = c), e = a.extend(!0, {}, a.jgrid.inlineEdit, e), this.each(function() {
					...
					if (f.grid && !1 !== (c = a(f).jqGrid("getInd", b, !0))) {
						var i = a.isFunction(e.beforeCancelRow) ? e.beforeCancelRow.call(f, e, b) : void
						0;
						if (void
							0 === i && (i = !0), i) {
							...
							if (g >= 0) {
								if (a.isFunction(a.fn.datepicker)) try {
									...
									} catch (a) {} a.each(f.p.colModel, function() {
		...
		addRow : function(b) {
			return b = a.extend(!0, {
					...
					if (this.grid) {
						var c = this;
						c.p.beforeAction = !0;
						var d = a.isFunction(b.beforeAddRow) ? b.beforeAddRow.call(c, b.addRowParams) : void
						0;
						if (void
		...
		editCell : function(b, c, d, e) {
			return this.each(function() {
				...
				if (j.grid && !0 === j.p.cellEdit) {
					...
					if (i = j.p.colModel[c], "subgrid" !== (f = i.name) && "cb" !== f && "rn" !== f) {
						try {
							h = a(j.rows[b].cells[c])
						} catch (d) {
							h = a("td:eq(" + c + ")", j.rows[b])
						}
						if (parseInt(j.p.iCol, 10) >= 0 && parseInt(j.p.iRow, 10) >= 0 && void
							0 !== j.p.iRowId) {
				...
				if (d.grid && !0 === d.p.cellEdit) {
					if (null !== e) {
						...
						case "button":
							...
							break;case "custom":
							try {
								if (!l.editoptions || !a.isFunction(l.editoptions.custom_value))
									throw "e1";
								if (void
									0 === (h = l.editoptions.custom_value.call(d, a(".customelement", k), "get")))
									throw "e2";
								i = h
							} catch (b) {
						...
						if (i !== d.p.savedRow[e].v) {
							var s = a(d).triggerHandler("jqGridBeforeSaveCell", [ d.p.savedRow[e].rowId, m, h, b, c ]);
							if (s && (h = s, i = s), a.isFunction(d.p.beforeSaveCell)) {
								var t = d.p.beforeSaveCell.call(d, d.p.savedRow[e].rowId, m, h, b, c);
								t && (h = t, i = t)
							}
							var u = a.jgrid.checkValues.call(d, h, c),
								v = !1;
							if (!0 === u[0]) {
								var w = a(d).triggerHandler("jqGridBeforeSubmitCell", [ d.p.savedRow[e].rowId, m, h, b, c ]) || {};
								a.isFunction(d.p.beforeSubmitCell) && ((w = d.p.beforeSubmitCell.call(d, d.p.savedRow[e].rowId, m, h, b, c)) || (w = {}));
								var x = a(d).triggerHandler("jqGridOnSubmitCell", [ d.p.savedRow[e].rowId, m, h, b, c ]);
								if (void
									0 === x && (x = !0), a.isFunction(d.p.onSubmitCell) && void
									0 === (x = d.p.onSubmitCell(d.p.savedRow[e].rowId, m, h, b, c)) && (x = !0), !1 === x) return;
								if (a("input.hasDatepicker", k).length > 0 && a("input.hasDatepicker", k).datepicker("hide"), "remote" === d.p.cellsubmit)
									if (d.p.cellurl) {
										...
										y[A] = a.jgrid.stripPref(d.p.idPrefix, d.p.savedRow[e].rowId), y[B] = z.editoper, y = a.extend(w, y), a(d).jqGrid("progressBar", {
											...
											complete : function(l, p) {
												if (a(d).jqGrid("progressBar", {
													...
													var q = a(d).triggerHandler("jqGridAfterSubmitCell", [ d, l, y[A], m, h, b, c ]) || [ !0, "" ];
										...
										} catch (a) {}"clientArray" === d.p.cellsubmit && (a(k).empty(), a(d).jqGrid("setCell", d.p.savedRow[e].rowId, c, i, !1, !1, !0), a(k).addClass("dirty-cell"), a(j).addClass("edited"), a(d).triggerHandler("jqGridAfterSaveCell", [ d.p.savedRow[e].rowId, m, h, b, c ]), a.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.p.savedRow[e].rowId, m, h, b, c), d.p.savedRow.splice(0, 1))
							} else
								try {
	...
	"use strict";a.fn.jqDrag = function(a) {
		return g(this, a, "d")
			...
			return d.each(function() {
				g = g ? a(g, d) : d, g.on("mousedown", {
					...
					if (e = {
						...
						} catch (a) {} return a(document).mousemove(a.jqDnR.drag).mouseup(a.jqDnR.stop), !1
				})
			})
		},
		h = function(a) {
					...
					var e,
						...
						m = function(b, c) {
							var e,
								f,
								g,
								h = a("<table class='" + j.rowTable + " ui-common-table'><tbody></tbody></table>"),
								i = a("<tr></tr>");
						...
						n = function(b, c) {
							...
							if (a(n).append(o), b && (i = d.p.jsonReader.subgrid, void
								0 !== (f = a.jgrid.getAccessor(b, i.root))))
								for (g = 0; g < f.length; g++) {
									if (h = f[g], o = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), !0 === i.repeatitems)
										for (i.cell && (h = h[i.cell]), m = 0; m < h.length; m++) l(o, h[m] || "&#160;", m);else {
		...
		groupingToggle : function(b) {
			return this.each(function() {
					...
					if (o.hasClass(k)) {
						if (n)
							for (; n && !(void
								0 !== (g = p(n.className)) && g <= f);) i = parseInt(a(n).attr("jqfootlevel"), 10), r = !isNaN(i) && (d.showSummaryOnHide && i <= f), r || a(n).hide(), n = n.nextSibling, s && (r || a(u).hide(), u = u.nextSibling);
			...
			return this.each(function() {
				...
				g(b, d, e, g, h) {
					var i,
						...
						q = "",
						r = !1;
					for (j = g; j < c; j++) o[j].hidden ? l = "<td " + k.formatCol(j, 1, "") + ">&#160;</td>" : !r && h ? (l = h, r = !0) : l = "<td " + k.formatCol(j, 1, "") + ">&#160;</td>", a.each(n.summary, function() {
							if (this.nm === o[j].name) {
								m = o[j].summaryTpl ? o[j].summaryTpl : "{0}", "string" == typeof
								this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && p > 0 && (this.v = this.v / p));try {
									this.groupCount = n.cnt, this.groupIndex = n.dataIndex, this.groupValue = n.value, i = k.formatter("", this.v, j, this)
								} catch (a) {
									i = this.v
								} return l = "<td " + k.formatCol(j, 1, "") + ">" + a.jgrid.template(m, i, n.cnt, n.dataIndex, n.displayValue) + "</td>", !1
							}
						}), q += l;
					return q
				}
				...
				u.reverse(), s = k.p.multiselect ? ' colspan="2"' : "", a.each(l.groups, function(f, v) {
					...
					t++, i = k.p.id + "ghead_" + v.idx, h = i + "_" + f, n = "<span style='cursor:pointer;margin-right:8px;margin-left:5px;' class='" + r.icon_base + " " + o + "' onclick=\"jQuery('#" + a.jgrid.jqID(k.p.id) + "').jqGrid('groupingToggle','" + h + "');return false;\"></span>";try {
					...
					if (w = a.isFunction(l.groupText[v.idx]) ? l.groupText[v.idx].call(k, j, v.cnt, v.summary) : a.jgrid.template(l.groupText[v.idx], j, v.cnt, v.summary), "string" != typeof
						...
						if ("header" !== l.groupSummaryPos[v.idx]) {
							...
							for (y = 0; y < t; y++)
								if (u[y]) {
									var E = "";
									l.groupCollapse && !l.showSummaryOnHide && (E = ' style="display:none;"'), m += "<tr" + E + ' jqfootlevel="' + (v.idx - y) + '" role="row" class="' + r.content + " jqfoot ui-row-" + k.p.direction + '">', m += g(f, y, l.groups, 0, !1), m += "</tr>"
							}
							t = D
						}
					}
					...
					for (a(q).prepend(x), e = a("<tr>", {
						...
						if (g = u[c].el, h = a(g), d = s[c], i = {
							...
							if (b.useColSpanStyle) {
								var C = h.attr("rowspan") ? parseInt(h.attr("rowspan"), 10) + 1 : 2;
								h.attr("rowspan", C)
							} else
								a("<th>", {
									role : "columnheader"
				...
				0 === b && (b = !0), this.each(function() {
					...
					if (k) {
						for (a(this).off(".setGroupHeaders"), c = a("<tr>", {
							...
							i = m[d].hidden ? "none" : "", g = a(f[d].el).width(f[d].width).css("display", i);try {
				...
				0 === c && (c = !1), this.each(function() {
					if (this.grid && this.p.treeGrid) {
						...
						for (var f = a(this).jqGrid("getNodeParent", b); f;) {
							if (d) try {
									f[d] = !0
								} catch (a) {} c ? e.unshift(f) : e.push(f), f = a(this).jqGrid("getNodeParent", f)
						}
					}
				}), e
		},
			...
			return this.each(function() {
					if (this.grid && this.p.treeGrid && i)
						for (c = this.p.localReader.id; i--;)
							if (j = a(this).jqGrid("getNodeAncestors", b[i], !0, !0), j.push(b[i]), d = j[0][c], -1 === a.inArray(d, k)) k.push(d), l = l.concat(j);else
									...
									if ("level" === d) {
										if (void
											...
											if (a.level - 1 == (l.rowTotals ? 1 : 0) && h > 0) {
												for (var j = 0, m = 0; m < h; m++) j += k[a.level - 1].groupHeaders[m].numberOfColumns;
												j && (i = j + t)
											}
		...
		jqPivot : function(b, c, d, e) {
			return this.each(function() {
				...
				f(b) {
					...
					if (i = c.xDimension.length, d.sortname) {
						for (f = d.sortorder ? d.sortorder : "asc", h = "text", e = 0; e < i; e++)
							if (c.xDimension[e].dataName === d.sortname) {
								h = c.xDimension[e].sorttype ? c.xDimension[e].sorttype : "text";break
						}
					...
					}, j.groupOptions, d || {}));var m = j.groupHeaders;
					if (m.length)
	...
	"use strict";a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
			...
			if (d = a.extend({
				...
				if (c) {
					...
					if ((e = a.jgrid.parseFunc(c)) && "object" === a.type(e)) {
						...
						e.shrinkToFit = !1, e.data = [], e.datatype = "local", e.grouping = !1, e.inlineNav && (h = k(e._iN), e._iN = null,
						delete
						e._iN
						), e.filterToolbar && (i = k(e._fT), e._fT = null,
						delete
						e._fT
						);
						var m = a("#" + b).jqGrid(e);
						if (d.restoreData && "" !== a.trim(g) && m.append(g), m.jqGrid("setGridParam", l), e.storeNavOptions && e.navGrid && (m[0].p.navGrid = !1, m.jqGrid("navGrid", e.pager, e.navOptions, e.editOptions, e.addOptions, e.delOptions, e.searchOptions, e.viewOptions), e.navButtons && e.navButtons.length))
							for (var n = 0; n < e.navButtons.length; n++) "sepclass" in
						...
						if (m[0].refreshIndex(), e.subGrid) {
							...
							m.jqGrid("addSubGrid", o + p), a.each(m[0].rows, function(b, c) {
								a(c).hasClass("ui-sg-expanded") && a(m[0].rows[b - 1]).find("td.sgexpanded").click().click()
							})
						}
						if (e.treeGrid)
							for (var q = 1, r = m[0].rows.length, s = e.expColInd, t = e.treeReader.leaf_field, u = e.treeReader.expanded_field; q < r;) a(m[0].rows[q].cells[s]).find("div.treeclick").on("click", function(b) {
									var c = b.target || b.srcElement,
		...
		jqGridExport : function(b) {
			...
			return this.each(function() {
					if (this.grid) {
						var d = a.extend(!0, {}, a(this).jqGrid("getGridParam"), b.addOptions);
			...
			if (this.each(function() {
					...
					d(b, c) {
								...
								if (m[i].exportcol) {
									...
									a.each(k.summary, function() {
										if (this.nm === m[i].name) {
											...
											this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && l > 0 && (this.v = this.v / l));try {
						...
						if (r.reverse(), "local" === j.p.datatype && !j.p.loadonce) {
							...
							for (var s = a.jgrid.getMethod("groupingPrepare"), t = 0; t < l; t++) s.call(a(j), k[t], t)
						}
					...
					b._regexsep = new RegExp(b.separator, "g"), b._regexquot = new RegExp(b.quote, "g");
					var e,
						f,
						g,
						h,
					...
					if (a.each(m, function(c, d) {
						...
						}), b.includeLabels && (u = v.join(b.separator) + b.newLine), b.collen = v.length, j.p.grouping) {
						var x = !!j.p.groupingView._locgr;
						j.p.groupingView._locgr = !1, q += d(k, b), j.p.groupingView._locgr = x
					} else
						for (; p < l;) {
					...
					if (b.includeGroupHeader && j.p.groupHeader && j.p.groupHeader.length) {
						...
						for (e = 0; e < y.length; e++) {
							...
							for (p = 0, g = [], i = 0; i < w.length; i++) {
								for (g[p] = "", h = 0; h < z.length; h++) z[h].startColumnName === w[i] && (g[p] = a.jgrid.formatCellCsv(z[h].titleText, b));
								p++
							}
					...
					if (b.includeFooter && j.p.footerrow) {
						if (a(".ui-jqgrid-ftable", this.sDiv).length) {
							...
							for (e = 0, g = []; e < b.collen;) {
								var B = w[e];
								A.hasOwnProperty(B) && g.push(a.jgrid.formatCellCsv(a.jgrid.stripHtml(A[B]), b)), e++
							}
			...
			b = a.extend(!0, {
				...
				d(b) {
							...
							if (m[k].exportcol) {
								...
								a.each(l.summary, function() {
									if (this.nm === m[k].name) {
										...
										this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && n > 0 && (this.v = this.v / n));try {
					...
					if (n.reverse(), "local" === g.p.datatype && !g.p.loadonce) {
						...
						for (var p = a.jgrid.getMethod("groupingPrepare"), q = 0; q < o.body.length; q++) p.call(a(g), o.body[q], q)
					}
						...
						for (var e = 15, f = 0; f < o.header.length; f++) {
							...
							for (var t = 0, u = a.jgrid.excelParsers.length; t < u; t++) {
								...
								if (s.match && !s.match(/^0\d+/) && s.match(v.match)) {
									...
									}), q.appendChild(h);break
								}
							}
							if (!h) {
								if ("number" == typeof
									s && s.toString().length <= e || l && l[1].length + (l[2] ? l[3].length : 0) <= e)
				...
				if (b.includeLabels && (s(o.header, !0), a("row:last c", j).attr("s", "2")), g.p.grouping) {
					var E = !!g.p.groupingView._locgr;
					g.p.groupingView._locgr = !1, d(o.body), g.p.groupingView._locgr = E
				} else
					for (var F = 0, G = o.body.length; F < G; F++) s(o.body[F], !1);
				...
				for (a("worksheet", j).prepend(H), n = 0, f = o.width.length; n < f; n++) H.appendChild(a.jgrid.makeNode(j, "col", {
						attr : {
							min : n + 1,
							max : n + 1,
							width : o.width[n],
				...
				a.isFunction(b.onBeforeExport) && b.onBeforeExport(l), o = null;try {
					var I = new JSZip,
						J = {
							type : "blob",
							mimeType : b.mimetype
						};
					a.jgrid.xmlToZip(I, l), I.generateAsync ? I.generateAsync(J).then(function(c) {
						a.jgrid.saveAs(c, b.fileName, {
							type : b.mimetype
						})
		...
		exportToPdf : function(b) {
			return b = a.extend(!0, {
					...
					c(b) {
						function
						c(b, c) {
							for (var d = 0, e = [], f = 0; f < m.length; f++) k = {
						...
						if (v.reverse(), "local" === h.p.datatype && !h.p.loadonce) {
							...
							for (var w = a.jgrid.getMethod("groupingPrepare"), x = 0; x < l.length; x++) w.call(a(h), l[x], x)
						}
					...
					if (b.includeLabels && i.push(p), h.p.grouping) {
						...
						h.p.groupingView._locgr = !1, c(l), h.p.groupingView._locgr = v
					} else {
						var w;
						for (n = 0, e = l.length; n < e; n++) {
							for (g = 0, p = [], w = l[n], f = 0; f < m.length; f++) k = {
									text : null == w[m[f]] ? "" : a.jgrid.formatCell(w[m[f]] + "", o[g], l[n], j[o[g]], h, "pdf"),
									alignment : r[m[f]],
									style : "tableBody"
								}, p.push(k), g++;
							i.push(p)
					...
					b.description && y.content.unshift({
						text : b.description,
						style : "description",
						margin : [ 0, 0, 0, 12 ]
					}), b.title && y.content.unshift({
						text : b.title,
						style : "title",
						margin : [ 0, 0, 0, 12 ]
					}), a.isFunction(b.onBeforeExport) && b.onBeforeExport.call(h, y);try {
						var z = pdfMake.createPdf(y);
						"open" === b.download ? z.open() : z.getBuffer(function(c) {
							a.jgrid.saveAs(c, b.fileName, {
								type : b.mimetype
							})
						})
			...
			return this.each(function() {
					...
					d(b) {
								...
								if (!h[m].hidden && h[m].exportcol) {
									...
									a.each(n.summary, function() {
										if (this.nm === h[m].name) {
											...
											this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && o > 0 && (this.v = this.v / o));try {
						...
						if (q.reverse(), "local" === g.p.datatype && !g.p.loadonce) {
							a(g).jqGrid("groupingSetup");
							for (var r = a.jgrid.getMethod("groupingPrepare"), s = 0; s < j.body.length; s++) r.call(a(g), j.body[s], s)
						}
					...
					for (e = 0, f = h.length; e < f; e++) void
						0 === h[e].exportcol && (h[e].exportcol = !0), !h[e].hidden && "cb" !== h[e].name && "rn" !== h[e].name && "subgrid" !== h[e].name && h[e].exportcol && (j.header[i] = h[e].name, j.width[i] = h[e].width, j.map[i] = e, j.align[i] = h[e].align || "left", i++);
					var k = document.createElement("a"),
						...
						n = function(a, b, c) {
							for (var d, e = "<tr>", f = 0, h = a.length; f < h; f++) d = !0 === c ? " style=width:" + j.width[f] + "px;" : "", e += "<" + b + d + ">" + g.p.colNames[j.map[f]] + "</" + b + ">";
							return e + "</tr>"
						},
						o = function(b, c, d, e, f) {
							for (var i, k, l = "<tr>", m = 0, n = j.header.length; m < n && (k = f ? ' colspan= "' + j.header.length + '" style=text-align:left' : !0 === e ? " style=width:" + j.width[m] + "px;text-align:" + j.align[m] + ";" : " style=text-align:" + j.align[m] + ";", i = j.header[m], b.hasOwnProperty(i) && (l += "<" + c + k + ">" + (d ? a.jgrid.formatCell(b[i], j.map[m], b, h[j.map[m]], g, "html") : b[i]) + "</" + c + ">"), !f); m++)
								;
							return l + "</tr>"
						},
						p = '<table class="' + b.tableClass + '">';
					if (b.includeLabels && (p += "<thead>" + n(j.header, "th", !0) + "</thead>"), p += "<tbody>", g.p.grouping) {
						var q = !!g.p.groupingView._locgr;
						g.p.groupingView._locgr = !1, p += d(j.body), g.p.groupingView._locgr = q
					} else
						for (var i = 0, f = j.body.length; i < f; i++) p += o(j.body[i], "td", !0, 0 === i);
					if (b.includeFooter && g.p.footerrow && (j.footer = a(g).jqGrid("footerData", "get", null, !1), p += o(j.footer, "td", !1)), p += "</tbody>", p += "</table>", b.returnAsString)
						c = p;else {
						var r = window.open("", "");
						r.document.close();
						...
						} r.document.body.innerHTML = (b.title ? "<h1>" + b.title + "</h1>" : "") + "<div>" + (b.topText || "") + "</div>" + p + "<div>" + (b.bottomText || "") + "</div>", a(r.document.body).addClass("html-view"), a("img", r.document.body).each(function(a, b) {
							b.setAttribute("src", m(b.getAttribute("src")))
						}), b.onBeforeExport && b.onBeforeExport(r), Boolean(r.chrome) ? b.autoPrint && (r.print(), r.close()) : setTimeout(function() {
	...
	"use strict";$.extend($.jgrid, {
					...
					parseElement = function(a) {
						if (7 !== a.nodeType) {
							...
							if (a.attributes && a.attributes.length)
								for (b = {}, c = 0; c < a.attributes.length; c++) "string" == typeof (d = a.attributes[c].nodeName) && (e = a.attributes[c].nodeValue) && (d = o.attr_prefix + d, void
		...
		saveAs : function(a, b, c) {
			...
			var d,
				e,
				f = [];
			b = null == b || "" === b ? "jqGridFile.txt" : b, $.isArray(a) ? f = a : f[0] = a;try {
				d = new File(f, b, c)
			} catch (a) {
				d = new Blob(f, c)
			}
	...
	$.jgrid.extend({
		...
		columnChooser : function(a) {
			...
			if (!$("#colchooser_" + $.jgrid.jqID(l[0].p.id)).length) {
				...
				i.parent().css("font-size", s), i.css({
					margin : "auto"
				}), i.find(">div").css({
					width : "100%",
					height : "100%",
	...
	a.fn.html5sortable = function(d) {
		...
		return d = a.extend({
				...
				var i = a("<" + (/^ul|ol$/i.test(this.tagName) ? "li" : /^tbody$/i.test(this.tagName) ? "tr" : "div") + ' class="sortable-placeholder ' + d.placeholderClass + '">').html("&nbsp;");
